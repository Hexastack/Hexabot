...
import BaseLlmHelper from '@/helper/lib/BaseLlmHelper';
...
export default class OllamaLlmHelper
  extends BaseLlmHelper
  implements OnApplicationBootstrap
{
  protected name: string = 'ollama';

  protected type: HelperType = HelperType.LLM;

  protected settings: HelperSetting[] = OLLAMA_HELPER_SETTINGS;
  ...
  async onApplicationBootstrap() {
    ...
    this.client = new Ollama({ host: settings.ollama.api_url });
  }

  // @ts-expect-error wait for y1sin to fix
