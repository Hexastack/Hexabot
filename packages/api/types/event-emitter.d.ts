...
import type { DEFAULT_SETTING_FIELDS } from '@/setting/seeds/setting.seed-model';
...
type DefaultHookSettingsMap = SettingEventMapFromFields<
  typeof DEFAULT_SETTING_FIELDS
>;
