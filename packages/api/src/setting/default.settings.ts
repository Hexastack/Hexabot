...
export const chatbotSettingsSchema = z.strictObject({
  ...
  default_flow_escape_helper: z
    ...
    .meta({
      ...
      description: 'Helper used when a conversation escapes the current flow.',
      'ui:widget': 'AutoCompleteWidget',
      'ui:options': {
...
export const ragSettingsSchema = z.strictObject({
  ...
  index_only_active_content: z.boolean().default(true).meta({
    ...
    description: 'Include only active content entries in the retrieval index.',
  }),
});
