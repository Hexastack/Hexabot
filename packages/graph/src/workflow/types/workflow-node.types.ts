...
export type AgentBindingOutPort =
  `${ELinkType.AGENT_BINDING_OUT}-${number}-${number}-${string}`;
export type TaskBindingOutPort =
  `${ELinkType.TASK_BINDING_OUT}-${number}-${number}-${string}`;
